...
import com.aloneness.well.tool.config.GenConfig;
...
public class GenUtils {
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        // 设置java字段名
        column.setJavaField(StrUtil.toCamelCase(StringUtils.lowerCase(columnName)));
        ...
        } else if (arraysContains(GenConstants.COLUMNTYPE_TIME_ALL, dataType)) {
            column.setHtmlType(GenConstants.HTML_DATETIME);
            if (arraysContains(GenConstants.COLUMNTYPE_DATETIME, dataType)) {
